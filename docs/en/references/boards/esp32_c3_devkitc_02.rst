...
.. figure:: ../../../_static/boards/esp32_c3_devkitc_02/esp32-c3-devkitc-02-v1-isometric.png
    :align: center
...
.. figure:: ../../../_static/boards/esp32_c3_devkitc_02/esp32-c3-devkitc-02-v1-annotated-photo.png
    :align: center
...
.. figure:: ../../../_static/boards/esp32_c3_devkitc_02/esp32-c3-devkitc-02-v1-block-diags.png
    :align: center
    :scale: 70%
...
The two tables below provide the **Name** and **Function** of the pin headers on both sides of the board (J1 and J3). The pin header names are shown in :ref:`user-guide-c3-devkitc-02-v1-board-front`. The numbering is the same as in the `ESP32-C3-DevKitC-02 Schematic <https://dl.espressif.com/dl/schematics/SCH_ESP32-C3-DEVKITC-02_V1_1_20210126A.pdf>`_ (PDF).
...
.. [2] GPIO2, GPIO8, and GPIO9 are strapping pins of the ESP32-C3 chip. These pins are used to control several chip functions depending on binary voltage values applied to the pins during chip power-up or system reset. For description and application of the strapping pins, please refer to Section Boot Configurations in `ESP32-C3 Datasheet <esp32_c3_devkitc_02-ESP32-C3 Datasheet>`_.

Pin Layout
^^^^^^^^^^

.. figure:: ../../../_static/boards/esp32_c3_devkitc_02/esp32-c3-devkitc-02-v1-pinout.png
    :align: center
    :width: 90%
...
* `ESP32-C3 Datasheet <esp32_c3_devkitc_02-ESP32-C3 Datasheet>`_ (PDF)
...
.. _esp32_c3_devkitc_02-ESP32-C3 Datasheet: https://www.espressif.com/sites/default/files/documentation/esp32-c3_datasheet_en.pdf
