...
* `AliExpress Espressif Official Store <https://www.aliexpress.com/item/1005004418342288.html>`__
...
(Note that at least when ordering from the UK and seemingly `EU and Europe <https://www.mouser.co.uk/saleterms/>`__, if you choose to
...
* `Training Book: Explore the power of Rust on the new Espressif board <https://github.com/esp-rs/std-training>`__

  * `Training Material <https://esp-rs.github.io/std-training/>`__
...
For the complete description, see the `ESP32-C3 Datasheet <https://www.espressif.com/sites/default/files/documentation/esp32-c3_datasheet_en.pdf>`__.
...
.. list-table::
   ...
   * - IMU
     - ICM-42670-P
     - `Datasheet <https://invensense.tdk.com/download-pdf/icm-42670-p-datasheet/>`__
     - `Link <https://crates.io/crates/icm42670>`__
     - 0x68
   * - Temperature and Humidity
     - SHTC3
     - `Datasheet <https://www.mouser.com/datasheet/2/682/Sensirion_04202018_HT_DS_SHTC3_Preliminiary_D2-1323493.pdf>`__
     - `Link <https://crates.io/crates/shtcx>`__
     - 0x70
...
`Interactive BOM <https://esp-rs.github.io/esp-rust-board/>`__

Case
^^^^


`Case 3D Printing Model <https://www.printables.com/model/288200-minimalistic-case-for-esp32-c3-devkit-rust-1>`__
