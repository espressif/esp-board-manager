...
Older version: `user_guide_v1.1 <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c5/esp32-c5-devkitc-1/user_guide_v1.1.html>`__
...
.. [3] MTMS, MTDI, GPIO7, GPIO25, GPIO26, GPIO27, and GPIO28 are strapping pins of the ESP32-C5 chip. These pins are used to control several chip functions depending on binary voltage values applied to the pins during chip power-up or system reset. For description and application of the strapping pins, please refer to `ESP32-C5 Datasheet <esp32_c5_devkitc_1-ESP32-C5 Datasheet>`_ > Section *Boot Configurations*.
...
`Initial release <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c5/esp32-c5-devkitc-1/user_guide_v1.1.html>`__
...
.. only:: latex
   ...
   Please download the following documents from `the HTML version of esp-dev-kits Documentation <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c5/index.html>`_.

* `ESP32-C5 Datasheet <esp32_c5_devkitc_1-ESP32-C5 Datasheet>`_ (PDF)
* `ESP32-C5-WROOM-1 & ESP32-C5-WROOM-1U Datasheet <esp32_c5_devkitc_1-ESP32-C5-WROOM-1 & ESP32-C5-WROOM-1U Datasheet>`_ (PDF)
...
.. _esp32_c5_devkitc_1-ESP32-C5 Datasheet: https://www.espressif.com/sites/default/files/documentation/esp32-c5_datasheet_en.pdf
.. _esp32_c5_devkitc_1-ESP32-C5-WROOM-1 & ESP32-C5-WROOM-1U Datasheet: https://www.espressif.com/sites/default/files/documentation/esp32-c5-wroom-1_wroom-1u_datasheet_en.pdf
