...
.. figure:: ../../../_static/boards/esp32_c3_devkitm_1/esp32-c3-devkitm-1-v1-isometric.png
    :align: center
...
.. figure:: ../../../_static/boards/esp32_c3_devkitm_1/esp32-c3-devkitm-1-v1-annotated-photo.png
    :align: center
...
.. figure:: ../../../_static/boards/esp32_c3_devkitm_1/esp32-c3-devkitm-1-v1-block-diagram.png
    :align: center
    :scale: 70%
...
The two tables below provide the **Name** and **Function** of the pin headers on both sides of the board (J1 and J3). The pin header names are shown in :ref:`user-guide-c3-devkitm-1-v1-board-front`. The numbering is the same as in the `ESP32-C3-DevKitM-1 Schematic <https://dl.espressif.com/dl/schematics/SCH_ESP32-C3-DEVKITM-1_V1_20200915A.pdf>`_ (PDF).
...
.. [2] GPIO2, GPIO8, and GPIO9 are strapping pins of the ESP32-C3 series of chips. These pins are used to control several chip functions depending on binary voltage values applied to the pins during chip power-up or system reset. For description and application of the strapping pins, please refer to Section Boot Configurations in `ESP32-C3 Datasheet <esp32_c3_devkitm_1-ESP32-C3 Datasheet>`_.


Pin Layout
^^^^^^^^^^

.. figure:: ../../../_static/boards/esp32_c3_devkitm_1/esp32-c3-devkitm-1-v1-pinout.png
    :align: center
    :width: 90%
...
* `ESP32-C3 Datasheet <esp32_c3_devkitm_1-ESP32-C3 Datasheet>`_ (PDF)
* `ESP32-C3-MINI-1 & ESP32-C3-MINI-1U Datasheet <esp32_c3_devkitm_1-ESP32-C3-MINI-1 & ESP32-C3-MINI-1U Datasheet>`_ (PDF)
...
* `ESP32-C3-DevKitM-1 Dimensions source file <https://dl.espressif.com/dl/schematics/DIMENSION_ESP32-C3-DEVKITM-1_V1_20200915AA.dxf>`_ (DXF)

For further design documentation for the board, please contact us at `sales@espressif.com <sales@espressif.com>`_.

.. _esp32_c3_devkitm_1-ESP32-C3 Datasheet: https://www.espressif.com/sites/default/files/documentation/esp32-c3_datasheet_en.pdf
.. _esp32_c3_devkitm_1-ESP32-C3-MINI-1 & ESP32-C3-MINI-1U Datasheet: https://www.espressif.com/sites/default/files/documentation/esp32-c3-mini-1_datasheet_en.pdf
