...
.. [tbr-a] The flash is integrated in the chip's package.
.. [tbr-b] It was 4 MB in some early samples.
...
- `ESP Thread Border Router/Zigbee Gateway Board CAD <https://dl.espressif.com/dl/schematics/ESP-Thread%20BR%26Zigbee%20GW_V1.zip>`_ (ZIP)
- `ESP Thread Border Router/Zigbee Gateway Sub-Ethernet CAD <https://dl.espressif.com/dl/schematics/ESP-Thread%20BR%26Zigbee%20GW_Sub_Ethernet_V1.zip>`_ (ZIP)
