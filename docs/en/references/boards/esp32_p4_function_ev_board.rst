...
The older version: `user_guide_v1.4 <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32p4/esp32-p4-function-ev-board/user_guide_v1.4.html>`__

.. note::

    If you are using ESP32-P4X-Function-EV-Board with chip revision v3.x, please refer to this :doc:`ESP32-P4X-C5-Function-EV-Board <esp32_p4x_c5_function_ev>`.

    The version number v1.5.2 refers to the board hardware version. To identify the embedded chip revision, refer to `ESP32-P4 Series SoC Errata <esp32_p4_function_ev_board-ESP32-P4 Series SoC Errata>`_ > `Chip Revision Identification <esp32_p4_function_ev_board-Chip Revision Identification>`_.
...
.. figure:: ../../../_static/boards/esp32_p4_function_ev_board/esp32-p4-function-ev-board-isometric_v1.5.2.png
    :align: center
...
.. figure:: ../../../_static/boards/esp32_p4_function_ev_board/esp32-p4-function-ev-board-annotated-photo-front_v1.5.2.png
    :align: center
    :width: 100%
...
.. figure:: ../../../_static/boards/esp32_p4_function_ev_board/esp32-p4-function-ev-board-annotated-photo-back_v1.5.2.png
    :align: center
    :width: 100%
...
.. figure:: ../../../_static/boards/esp32_p4_function_ev_board/ribbon_cable.png
    :align: center
    :scale: 30%
...
- `ESP_Brookesia Phone <https://github.com/espressif/esp-dev-kits/tree/master/examples/esp32-p4-function-ev-board/examples/esp_brookesia_phone>`__ - Demonstrates an Android-like interface with multiple applications using ESP_Brookesia, utilizing MIPI-DSI, MIPI-CSI, ESP32-C6, SD card, and audio interfaces on a development board, providing a basis for efficient multimedia application development.
- `LVGL Demo v8 <https://github.com/espressif/esp-dev-kits/tree/master/examples/esp32-p4-function-ev-board/examples/lvgl_demo_v8>`__ - Demonstrates how to port LVGL v8 and conduct performance testing using LVGL's built-in demos on an ESP32-P4-Function-EV-Board with a 7-inch LCD screen, serving as a foundation for developing applications based on LVGL v8.
- `LVGL Demo v9 <https://github.com/espressif/esp-dev-kits/tree/master/examples/esp32-p4-function-ev-board/examples/lvgl_demo_v9>`__ - Demonstrates how to port LVGL v9 and conduct performance testing using LVGL's built-in demos on an ESP32-P4-Function-EV-Board, serving as a basis for developing applications based on LVGL v9.

For more examples and the latest updates, please refer to the `examples <https://github.com/espressif/esp-dev-kits/tree/master/examples/esp32-p4-function-ev-board>`__ folder.
...
.. figure:: ../../../_static/boards/esp32_p4_function_ev_board/esp32-p4-function-ev-board-block-diagram_v1.5.2.png
    :align: center
    :width: 100%
...
`Initial release <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32p4/esp32-p4-function-ev-board/user_guide_v1.4.html>`__
...
* `1.0K-GT-15PB Specification <esp32_p4_function_ev_board-1.0K-GT-15PB Specification>`_ (PDF)
* `Camera Datasheet <esp32_p4_function_ev_board-Camera Datasheet>`_ (PDF)
* `Display Datasheet <esp32_p4_function_ev_board-Display Datasheet>`_ (PDF)
* `Datasheet of display driver chip EK73217BCGA <esp32_p4_function_ev_board-Datasheet of display driver chip EK73217BCGA>`_ (PDF)
* `Datasheet of display driver chip EK79007AD <esp32_p4_function_ev_board-Datasheet of display driver chip EK79007AD>`_ (PDF)
* `LCD Adapter Board Schematic <esp32_p4_function_ev_board-LCD Adapter Board Schematic>`_ (PDF)
* `LCD Adapter Board PCB Layout <esp32_p4_function_ev_board-LCD Adapter Board PCB Layout>`_ (PDF)
* `Camera Adapter Board Schematic <esp32_p4_function_ev_board-Camera Adapter Board Schematic>`_ (PDF)
* `Camera Adapter Board PCB Layout <esp32_p4_function_ev_board-Camera Adapter Board PCB Layout>`_ (PDF)
...
.. _esp32_p4_function_ev_board-1.0K-GT-15PB Specification: https://dl.espressif.com/dl/schematics/1.0K-GT-15PB_specification.pdf
.. _esp32_p4_function_ev_board-Camera Datasheet: https://dl.espressif.com/dl/schematics/camera_datasheet.pdf
.. _esp32_p4_function_ev_board-Display Datasheet: https://dl.espressif.com/dl/schematics/display_datasheet.pdf
.. _esp32_p4_function_ev_board-Datasheet of display driver chip EK73217BCGA: https://dl.espressif.com/dl/schematics/display_driver_chip_EK73217BCGA_datasheet.pdf
.. _esp32_p4_function_ev_board-Datasheet of display driver chip EK79007AD: https://dl.espressif.com/dl/schematics/display_driver_chip_EK79007AD_datasheet.pdf
.. _esp32_p4_function_ev_board-LCD Adapter Board Schematic: https://dl.espressif.com/dl/schematics/esp32-p4-function-ev-board-lcd-subboard-schematics.pdf
.. _esp32_p4_function_ev_board-LCD Adapter Board PCB Layout: https://dl.espressif.com/dl/schematics/esp32-p4-function-ev-board-lcd-subboard-pcb-layout.pdf
.. _esp32_p4_function_ev_board-Camera Adapter Board Schematic: https://dl.espressif.com/dl/schematics/esp32-p4-function-ev-board-camera-subboard-schematics.pdf
.. _esp32_p4_function_ev_board-Camera Adapter Board PCB Layout: https://dl.espressif.com/dl/schematics/esp32-p4-function-ev-board-camera-subboard-pcb-layout.pdf
.. _esp32_p4_function_ev_board-Chip Revision Identification: https://docs.espressif.com/projects/esp-chip-errata/en/latest/esp32p4/01-chip-identification/index.html#
.. _esp32_p4_function_ev_board-ESP32-P4 Series SoC Errata: https://docs.espressif.com/projects/esp-chip-errata/en/latest/esp32p4/index.html
