...
This guide shows how to get started with the ESP32-PICO-KIT v4/v4.1 mini development board. For the description of other ESP32-PICO-KIT versions, please check `user_guide_v3 <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32/esp32-pico-kit/user_guide_v3.html>`__.
...
18      EN                 I       | CHIP_PU
19      GND                P       | Ground
20      VDD33 (3V3)        P       | 3.3 V power supply
======  =================  ======  ======================================================
...
19      GND                P       | Ground
20      EXT_5V (5V)        P       | 5 V power supply
======  =================  ======  ======================================================
