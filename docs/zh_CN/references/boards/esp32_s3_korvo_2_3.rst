...
最新版本： `ESP32-S3-Korvo-2 V3.1 <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/design-guide/dev-boards/user-guide-esp32-s3-korvo-2.html>`__
...
ESP32-S3-Korvo-2 V3.0 主板可与 LCD 扩展板 `ESP32-S3-Korvo-2-LCD <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/design-guide/dev-boards/user-guide-esp32-s3-korvo-2-lcd.html>`__ 搭配使用。本文档主要介绍 ESP32-S3-Korvo-2 V3.0 主板，更多关于 LCD 扩展板的信息，请参阅 `ESP32-S3-Korvo-2-LCD 用户指南 <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/design-guide/dev-boards/user-guide-esp32-s3-korvo-2-lcd.html>`__。
...
请前往 `快速入门 <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/get-started/index.html>`__，查看如何快速设置开发环境，并将 `应用程序示例 <https://github.com/espressif/esp-adf/tree/master/examples>`__ 烧录至您的开发板。
