...
.. |ESP32-DevKitM-1-正面| image:: ../../../_static/boards/esp32_devkitm_1/esp32-DevKitM-1-front.png

.. |ESP32-DevKitM-1-侧面| image:: ../../../_static/boards/esp32_devkitm_1/esp32-DevKitM-1-isometric.png


本指南包括：

- `快速入门 <#快速入门>`__：提供 ESP32-DevKitM-1 的简要概述及必要的硬件和软件信息。
