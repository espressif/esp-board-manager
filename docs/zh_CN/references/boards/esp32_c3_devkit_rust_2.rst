...
.. [2] GPIO2、GPIO8 和 GPIO9 为 ESP32-C3 芯片的 Strapping 管脚。在芯片上电和系统复位过程中，Strapping 管脚根据管脚的二进制电压值控制芯片功能。Strapping 管脚的具体描述和应用，请参考 `ESP32-C3 技术规格书 <esp32_c3_devkit_rust_2-ESP32-C3 技术规格书>`_ 的启动配置项章节。
...
* `ESP32-C3 技术规格书 <esp32_c3_devkit_rust_2-ESP32-C3 技术规格书>`_ (PDF)
...
.. _esp32_c3_devkit_rust_2-ESP32-C3 技术规格书: https://www.espressif.com/sites/default/files/documentation/esp32-c3_datasheet_cn.pdf
