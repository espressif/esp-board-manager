...
开发板的应用示例存放在 `application example <https://github.com/espressif/esp-adf/tree/master/examples>`__ 中。
...
硬件设置完成后，请前往 `快速入门 <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/get-started/index.html>`__，准备开发工具。
