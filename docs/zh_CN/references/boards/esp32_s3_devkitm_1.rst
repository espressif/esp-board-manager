...
.. note::
    ...
    由于 ESP32-S3-DevKitM-1 开发板与 ESP32-S3-DevKitC-1-N8R8 和 ESP32-S3-DevKitC-1U-N8R8 在功能和用途上基本一致，ESP32-S3-DevKitM-1 已停止生产。开发者可使用 ESP32-S3-DevKitC-1-N8R8 或 ESP32-S3-DevKitC-1U-N8R8 进行软件及基础功能测试（请参考 :doc:`ESP32-S3-DevKitC-1 用户指南 <esp32_s3_devkitc_1>`）。上述调整不影响其所搭载 ESP32-S3-MINI-1/1U 模组的正常供货。
...
- `ESP32-S3-DevKitM-1 参考设计 <https://documentation.espressif.com/ESP32-S3-DevKitM-1_Reference_Design.zip>`__ (ZIP)
