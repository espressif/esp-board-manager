...
- `factory <https://github.com/espressif/esp-dev-kits/tree/master/examples/esp32-s3-usb-otg/examples/factory>`__ - 演示了 ESP32-S3-USB-OTG 开发板的工厂演示，为使用 ESP-IDF 和 ESP Launchpad 构建、烧录和监控项目提供了参考。

更多示例及最新更新请参阅 `examples <https://github.com/espressif/esp-dev-kits/tree/master/examples/esp32-s3-usb-otg>`__ 文件夹。
...
请注意，该接口支持连接 SPI 接口屏幕，该开发板使用的屏幕型号为 `ST7789 <https://dl.espressif.com/AE/esp-dev-kits/ST7789VW芯片手册.pdf>`_，``LCD_BL`` (GPIO9) 可用于控制屏幕背光。
...
-  `ESP32-S3-USB-OTG 参考设计 <https://documentation.espressif.com/ESP32-S3-USB-OTG_Reference_Design.zip>`__ (ZIP)
-  `ST7789VW 规格书 <esp32_s3_usb_otg-ST7789VW 规格书>`_ (PDF)
...
.. _esp32_s3_usb_otg-ST7789VW 规格书: https://dl.espressif.com/dl/schematics/ST7789VW_datasheet.pdf
