...
本文档介绍 ESP32-LyraT V4.3 音频开发板的功能说明与配置选项。如需了解 LyraT 的功能与基本用法，请参阅 `get-started-esp32-lyrat <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/design-guide/dev-boards/get-started-esp32-lyrat.html>`__。若您使用的开发板版本不同，请查看 `其他 LyraT 开发板版本`_ 一节。
...
* `get-started-esp32-lyrat-v4.2 <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/design-guide/dev-boards/get-started-esp32-lyrat-v4.2.html>`__
* `get-started-esp32-lyrat-v4 <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/design-guide/dev-boards/get-started-esp32-lyrat-v4.html>`__
...
* `get-started-esp32-lyrat <https://docs.espressif.com/projects/esp-adf/zh_CN/latest/design-guide/dev-boards/get-started-esp32-lyrat.html>`__
