...
更早版本：`user_guide_v1.1 <https://docs.espressif.com/projects/esp-dev-kits/zh_CN/latest/esp32c5/esp32-c5-devkitc-1/user_guide_v1.1.html>`__

本指南将帮助您快速上手 ESP32-C5-DevKitC-1，并提供该款开发板的详细信息。

ESP32-C5-DevKitC-1 是一款入门级开发板，使用通用型模组 `ESP32-C5-WROOM-1(U) <https://www.espressif.com/sites/default/files/documentation/esp32-c5-wroom-1_wroom-1u_datasheet_cn.pdf>`_。该款开发板具备完整的 Wi-Fi、低功耗蓝牙、Zigbee 及 Thread 功能。

板上模组大部分管脚均已引出至两侧排针，开发人员可根据实际需求，轻松通过跳线连接多种外围设备，同时也可将开发板插在面包板上使用。

.. figure:: ../../../_static/boards/esp32_c5_devkitc_1/esp32-c5-devkitc-1-isometric_v1.1.png
    :align: center
...
.. figure:: ../../../_static/boards/esp32_c5_devkitc_1/ESP32-C5-DevKitC-1_callouts.png
    :align: center
...
.. list-table::
   ...
   * - 主要组件
     - 介绍
   * - ESP32-C5-WROOM-1(U)
     - ESP32-C5-WROOM-1(U) 是通用型模组，支持  2.4 & 5 GHz 双频 Wi-Fi 6 (802.11ax)、 Bluetooth® 5 (LE)、 Zigbee 及 Thread (802.15.4)，采用板载 PCB 天线。
   * - 排针
...
.. figure:: ../../../_static/boards/esp32_c5_devkitc_1/ESP32-C5-DevKitC-1-block-diagram.png
    :align: center
    :scale: 70%
...
开发板上的 J5 排针（见图 :ref:`user-guide-c5-devkitc-1-board-v1.2-front` 中的 J5）可用于测量 ESP32-C5-WROOM-1(U) 模组的电流：
...
下表列出了开发板两侧排针（J1 和 J3）的 **名称** 和 **功能**\ ，排针的名称如图 :ref:`user-guide-c5-devkitc-1-board-v1.2-front` 所示，排针的序号与 `ESP32-C5-DevKitC-1 原理图 v1.2`_ (PDF) 一致。
...
.. [2] 用于驱动 RGB LED。
.. [3] MTMS、MTDI、GPIO7、GPIO25、GPIO26、GPIO27 和 GPIO28 为 ESP32-C5 芯片的 Strapping 管脚。在芯片上电和系统复位过程中，Strapping 管脚根据管脚的二进制电压值控制芯片功能。Strapping 管脚的具体描述和应用，请参考 `ESP32-C5 技术规格书 <esp32_c5_devkitc_1-ESP32-C5 技术规格书>`_ > *启动配置项* 章节。
.. [4] 在集成 SPI PSRAM 的模组中，此管脚已被用作 SPICS1 功能，外部不可使用；在未集成 SPI PSRAM 的模组中，此管脚可用作 GPIO15。


管脚布局
^^^^^^^^
.. figure:: ../../../_static/boards/esp32_c5_devkitc_1/esp32-c5-devkitc-1-pin-layout_v1.2.png
    :align: center
    :width: 90%
...
生产工单号为 PW-2025-04-0446 及之后的开发板，J1 和 J3 排针功能更新，详见章节 `排针`_。
...
`首次发布 <https://docs.espressif.com/projects/esp-dev-kits/zh_CN/latest/esp32c5/esp32-c5-devkitc-1/user_guide_v1.1.html>`__
...
.. only:: latex
   ...
   请前往 `esp-dev-kits 文档 HTML 网页版本 <https://docs.espressif.com/projects/esp-dev-kits/zh_CN/latest/esp32c5/index.html>`_ 下载以下文档。

* `ESP32-C5 技术规格书 <esp32_c5_devkitc_1-ESP32-C5 技术规格书>`_ (PDF)
* `ESP32-C5-WROOM-1 & ESP32-C5-WROOM-1U 技术规格书 <esp32_c5_devkitc_1-ESP32-C5-WROOM-1 & ESP32-C5-WROOM-1U 技术规格书>`_ (PDF)
...
.. _esp32_c5_devkitc_1-ESP32-C5 技术规格书: https://www.espressif.com/sites/default/files/documentation/esp32-c5_datasheet_cn.pdf
.. _esp32_c5_devkitc_1-ESP32-C5-WROOM-1 & ESP32-C5-WROOM-1U 技术规格书: https://www.espressif.com/sites/default/files/documentation/esp32-c5-wroom-1_wroom-1u_datasheet_cn.pdf
.. _ESP32-C5-DevKitC-1 原理图 v1.2: https://dl.espressif.com/dl/schematics/SCH_ESP32-C5-DevkitC-1_V1.2_20250211.pdf
.. _ESP32-C5-DevKitC-1 PCB 布局图 v1.2: https://dl.espressif.com/dl/schematics/PCB_ESP32-C5-DevKitC-1_V1.2_20250211.pdf
.. _ESP32-C5-DevKitC-1 尺寸图 v1.2: https://dl.espressif.com/dl/schematics/Dimension_esp32-c5-devkitc-1_v1.2_20250509.pdf
.. _ESP32-C5-DevKitC-1 尺寸图 v1.2 源文件: https://dl.espressif.com/dl/schematics/Dimension_esp32-c5-devkitc-1_v1.2_20250509.dxf
