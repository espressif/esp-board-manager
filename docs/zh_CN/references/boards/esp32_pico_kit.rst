...
本指南介绍了如何开始使用 ESP32-PICO-KIT V4/V4.1 迷你开发板。有关 ESP32-PICO-KIT 其他版本的介绍，请见：`user_guide_v3 <https://docs.espressif.com/projects/esp-dev-kits/zh_CN/latest/esp32/esp32-pico-kit/user_guide_v3.html>`__。
...
ESP32-PICO-KIT 是一款来自 `乐鑫 <https://www.espressif.com/zh-hans/>`_ 的迷你开发板。
...
.. figure:: ../../../_static/boards/esp32_pico_kit/esp32-pico-kit-overview.png
    :align: center
    :scale: 40%
    :alt: ESP32-Pico-Kit
...
.. figure:: ../../../_static/boards/esp32_pico_kit/esp32-pico-kit-v4-functional-block-diagram.png
    :align: center
...
.. figure:: ../../../_static/boards/esp32_pico_kit/esp32-pico-kit-v4.1-f-layout.jpeg
    :align: center
...
下表介绍了开发板 I/O 管脚的 **名称** 和 **功能**\ ，具体布局请见 `相关文档`_ 中的原理图。请参考 :ref:`ESP32-PICO-KIT 开发板布局（排母版） <get-started-pico-kit-v4-board-front>`。
...
编号     名称               类型     功能
======  =================  ======  ======================================================
1       FLASH_SD1 (FSD1)   I/O     | GPIO8, SD_DATA1, SPID, HS1_DATA1 :ref:`（见备注 1） <get-started-pico-kit-v4-pin-notes>` , U2CTS
2       FLASH_SD3 (FSD3)   I/O     | GPIO7, SD_DATA0, SPIQ, HS1_DATA0 :ref:`（见备注 1） <get-started-pico-kit-v4-pin-notes>` , U2RTS
3       FLASH_CLK (FCLK)   I/O     | GPIO6, SD_CLK, SPICLK, HS1_CLK :ref:`（见备注 1） <get-started-pico-kit-v4-pin-notes>` , U1CTS
...
12      RXD0               I/O     | GPIO3, U0RXD :ref:`（见备注 3） <get-started-pico-kit-v4-pin-notes>` , CLK_OUT2
13      TXD0               I/O     | GPIO1, U0TXD :ref:`（见备注 3） <get-started-pico-kit-v4-pin-notes>` , CLK_OUT3, EMAC_RXD2
...
编号     名称                类型    功能
======  =================  ======  ======================================================
1       FLASH_CS (FCS)     I/O     | GPIO16, HS1_DATA4 :ref:`（见备注 1） <get-started-pico-kit-v4-pin-notes>` , U2RXD, EMAC_CLK_OUT
2       FLASH_SD0 (FSD0)   I/O     | GPIO17, HS1_DATA5 :ref:`（见备注 1） <get-started-pico-kit-v4-pin-notes>` , U2TXD, EMAC_CLK_OUT_180
3       FLASH_SD2 (FSD2)   I/O     | GPIO11, SD_CMD, SPICS0, HS1_CMD :ref:`（见备注 1） <get-started-pico-kit-v4-pin-notes>` , U1RTS
...
8       IO32               I/O     | 32K_XP :ref:`（见备注 2a） <get-started-pico-kit-v4-pin-notes>` , ADC1_CH4, TOUCH9, RTC_GPIO9
9       IO33               I/O     | 32K_XN :ref:`（见备注 2b） <get-started-pico-kit-v4-pin-notes>` , ADC1_CH5, TOUCH8, RTC_GPIO8
10      IO27               I/O     | GPIO27, ADC2_CH7, TOUCH7, RTC_GPIO17
                                   | EMAC_RX_DV
11      IO14               I/O     | ADC2_CH6, TOUCH6, RTC_GPIO16, MTMS, HSPICLK,
                                   | HS2_CLK, SD_CLK, EMAC_TXD2
12      IO12               I/O     | ADC2_CH5, TOUCH5, RTC_GPIO15, MTDI :ref:`（见备注 4） <get-started-pico-kit-v4-pin-notes>` , HSPIQ,
...
17      IO0                I/O     | ADC2_CH1, TOUCH1, RTC_GPIO11, CLK_OUT1
                                   | EMAC_TX_CLK
18      VDD33 (3V3)        P       | 3.3 V 电源
19      GND                P       | Ground
20      EXT_5V (5V)        P       | 5 V 电源
======  =================  ======  ======================================================
...
管脚布局
^^^^^^^^^^^
.. figure:: ../../../_static/boards/esp32_pico_kit/esp32-pico-kit-v4-pinout.png
    :align: center
    :scale: 43%
    :alt: ESP32-PICO-KIT 管脚布局
...
.. figure:: ../../../_static/boards/esp32_pico_kit/esp32-pico-kit-v4.1-dimensions-back.jpg
    :align: center
...
.. figure:: ../../../_static/boards/esp32_pico_kit/esp32-pico-kit-v4-dimensions-side.jpg
    :align: center
