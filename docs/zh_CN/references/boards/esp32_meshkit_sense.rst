...
.. figure:: ../../../_static/boards/esp32_meshkit_sense/ESP32_BATTERY_EB.png
   :align: center
...
.. figure:: ../../../_static/boards/esp32_meshkit_sense/EBPCB.png
   :align: center
   :alt: ESP32-MeshKit-Sense
   :figclass: align-center
...
APDS-9960 是一款集成 ALSO、红外 LED 和接近检测器的光学模块和环境亮度感测的环境亮度传感器。开发板 采用 3.3 V 供电，以及 I2C 的接口方式。需说明的是，此款传感器当前设计中默认为不上件的状态。
